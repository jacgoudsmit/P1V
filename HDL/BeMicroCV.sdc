...
create_clock -name DDR_CLK_50MHZ -period 20.000 [get_ports {DDR_CLK_50MHZ}]
...
set_output_delay -clock clock_io -min 0 [get_ports {LED* J1*}]
set_output_delay -clock clock_io -max 0 [get_ports {LED* J1*}]
...
set_false_path -from [get_ports {TACT_N[1]}]
