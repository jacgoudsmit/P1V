...
set_input_delay -clock clock_io -min 0 [get_ports {io* fpga_rx fpga_resn}]
set_input_delay -clock clock_io -max 0 [get_ports {io* fpga_rx fpga_resn}]
...
set_output_delay -clock clock_io -min 0 [get_ports {led* io* fpga_tx}]
set_output_delay -clock clock_io -max 0 [get_ports {led* io* fpga_tx}]
...
set_false_path -from [get_ports {fpga_*}]
