...
set_input_delay -clock clock_io -min 0 [get_ports {GPIO*}]
set_input_delay -clock clock_io -max 0 [get_ports {GPIO*}]
...
set_output_delay -clock clock_io -min 0 [get_ports {LED* GPIO*}]
set_output_delay -clock clock_io -max 0 [get_ports {LED* GPIO*}]
